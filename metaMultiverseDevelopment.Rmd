...
```{r}
plot_descriptive_spec_curve_plotly <- function(data, 
                                               ylim_lower = NULL, 
                                               ylim_upper = NULL,
                                               colorblind_friendly = TRUE) {
...
## Test `plot_descriptive_spec_curve_plotly`
```{r}
# Generate plot
plot_descriptive_spec_curve_plotly(res, ylim_upper = 2, ylim_lower = -2, colorblind_friendly = FALSE)
```
