...
#'
#' @export
run_multiverse_analysis <- function(data, specifications, factor_groups = NULL, verbose = FALSE, progress = TRUE) {
  ...
  # Main analysis loop - KEY CHANGE: Pass factor_groups to general_multiverse
  results <- lapply(seq_len(n_specs), function(i) {
    ...
    tryCatch({
      withCallingHandlers({
        # *** KEY CHANGE: Pass factor_groups to general_multiverse ***
