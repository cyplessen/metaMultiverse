...
plot_spec_curve(example_U)
plot_voe(example_U)


plot_spec_curve(example_N)
plot_voe(example_N)
```
...
# Update package loop
```{r}
# 1. Document - updates NAMESPACE and documentation from roxygen2 comments
devtools::document()

# 2. Load/install the package locally for testing
...
```{r}
# 4. Full check - comprehensive package check
devtools::check()  # or Ctrl/Cmd + Shift + E
```
